...
{LA_IS, { T_LRBIND_0 }, { "bind_to_right",{\
    {LA_IS, {""}, 3, { T_LRBIND_0, "ident", "index_action__optional" }}\
}}},\
{ LA_IS, { T_LRBIND_0 }, { "bind_to_right__optional",{\
    { LA_IS, {""}, 1, { "bind_to_right" }}\
}}},\
...
{LA_IS, { "ident_terminal" }, { "statement", {\
    ...
    { LA_NOT, { T_COLON_0 }, 1, {"expression_or_bind_left_to_right"}}\
}}},\
{LA_IS, { "(", T_NOT_0, "unsigned_value_terminal", T_ADD_0, T_SUB_0 }, { "statement", {\
    { LA_IS, {""}, 1, {"expression_or_bind_left_to_right"}}\
}}},\
{LA_IS, { T_IF_0 }, { "statement",{\
    {LA_IS, {""}, 1, {"cond_block__with_optional_bind"}}\
}}},\
